...
public static class BulletUtility
{
    ...
    /// 일정한 각으로 발사
    /// </summary>
    public static List<T> AngleShoot<T>(BulletData bulletData, PoolType poolType, Transform parent, Vector2 pos, int count, float startAngle, float angle) where T : Bullet
    {
